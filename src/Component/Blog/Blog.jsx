...
const Blog = ({ blog, handleAddToBookmark, handleReadinTime }) => {
  ...
  return (
    <div className="p-5 md:p-0 my-8 mb-3">
      ...
      <button onClick={() => handleReadinTime(id, reading_time)} className=" text-indigo-800 underline decoration-1 text-xl  my-3">
        Mark as read
      </button>
    </div>
  );
